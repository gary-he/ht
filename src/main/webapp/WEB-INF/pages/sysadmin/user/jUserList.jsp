...
<table id="ec_table" class="tableRegion" width="98%" >
	...
	<tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'">
		...
		<td>
			<c:if test="${user.state==1}"><a href="stop?userId=${user.userId}"><font color="green">启用</font></a></c:if>
			<c:if test="${user.state==0}"><a href="start?userId=${user.userId}"><font color="red">停用</font></a></c:if>
		</td>
	</tr>
	</c:forEach>
